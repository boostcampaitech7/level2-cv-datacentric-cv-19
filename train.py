...
def do_training(data_dir, model_dir, epoch_start,pretrained_path,device, image_size, input_size, num_workers, batch_size,
    ...
    for epoch in range(epoch_start,max_epoch):
        epoch_loss, epoch_start = 151, time.time()
